...
csv = read('myds.csv', delimiter=';')

catnames = {1: "агрессивные высказывания", 2: "поиск новой работы", 3: "финансовые вопросы", 4:"стандартные сообщения", 5:"бессмысленные сообщения"}
